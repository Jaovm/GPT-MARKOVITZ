...
def calculate_fair_price(sector, pe_ratio, pb_ratio, eps, roe): if sector == "Financial Services" and pb_ratio and roe: return pb_ratio * roe * 10 elif pe_ratio and eps: return pe_ratio * eps return None
